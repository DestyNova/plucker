...
/*!
    ...
    \licence    GPL
    \brief      Describes body_dialog class    
    \author     Robert O'Connor
    \date       2002/01/03    
 */  
// RCS-ID:      $Id: body_dialog.h,v 1.7 2007/06/29 00:58:50 robertoconnor Exp $
//----------------------------------------------------------------------------------------
...
#ifndef _BODY_DIALOG_H_
#define _BODY_DIALOG_H_
...
//----------------------------------------------------------------------------------------
    ...
    #pragma interface "body_dialog.h"
#endif
...
//----------------------------------------------------------------------------------------
// Class definition: body_dialog
//----------------------------------------------------------------------------------------

//! A dialog for a "body" tag for the HTML editor.
class body_dialog : public wxDialog
{
...
private:
    ...
    void on_text_color_button( wxCommandEvent& event );
    void on_link_color_button( wxCommandEvent& event );
