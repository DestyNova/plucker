/*
 * $Id: doclist.h,v 1.14 2005/08/08 02:30:59 prussar Exp $
 *
...
/* return publication date if found in doc */
extern UInt32 GetPublicationDate( DocumentInfo* docInfo ) DOCLIST_SECTION;
