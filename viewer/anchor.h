/*
 * $Id: anchor.h,v 1.33 2006/11/09 13:19:14 prussar Exp $
 *
...
void AnchorSetByteOffset( const TextContext* tContext, UInt16 offset )
    ANCHOR_SECTION;
...
#ifdef SUPPORT_ANNOTATION
/* Return the reference of a visible anchor */
extern AnchorMode GetVisibleMode(const Int16 index) ANCHOR_SECTION;
AnnotationIdentifier* GetVisibleAnnotationIdentifier( const Int16 index ) 
    ANCHOR_SECTION;
#else
#define GetVisibleMode( index ) ANCHORMODE_LINK
#endif
