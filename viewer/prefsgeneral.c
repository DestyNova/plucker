/*
 * $Id: prefsgeneral.c,v 1.14 2006/11/12 16:23:44 prussar Exp $
 *
    ...
    )
{
    ...
    switch ( action ) {
        ...
        case SAVE:
        {
            ...
            Prefs()->alwaysDeleteAnnotations = CtlGetValue(
                GetObjectPtr( frmPrefsGeneralAlwaysDeleteAnnotations ) );

#ifdef SUPPORT_ANNOTATION
            Prefs()->noAnnotationsInBookmarkList = ! CtlGetValue(
                GetObjectPtr( frmPrefsGeneralAnnotationsInBookmarkList ) );
#endif
...
static void LoadGeneralPrefs( void )
{
    ...
    CtlSetValue( GetObjectPtr( frmPrefsGeneralAlwaysDeleteAnnotations ),
        Prefs()->alwaysDeleteAnnotations );

#ifdef SUPPORT_ANNOTATION
    CtlSetValue( GetObjectPtr( frmPrefsGeneralAnnotationsInBookmarkList ),
