/*
 * $Id: history.c,v 1.36 2005/08/27 15:08:59 prussar Exp $
 *
...
void SetIndividualSettingsToDefaults
     (
     History*   historyP
     )
{
    historyP->font                    = Prefs()->defaultFontModeMain;
    historyP->lineSpacing             = Prefs()->defaultLineSpacing;
    historyP->paragraphSpacing        = Prefs()->defaultParagraphSpacing;
    historyP->rotate                  = Prefs()->defaultRotate;
    historyP->rtl                     = Prefs()->defaultRTL;
    historyP->underlineMode           = Prefs()->defaultUnderlineMode;
    historyP->pageControlsLink        = Prefs()->defaultPageControlsLink;
    historyP->enableSoftHyphens       = Prefs()->defaultEnableSoftHyphens;
    historyP->forceAlign              = Prefs()->defaultForceAlign;
    historyP->strikethrough           = Prefs()->defaultStrikethrough;
    historyP->forceDefaultColors      = Prefs()->defaultForceDefaultColors;
    historyP->selectWordTap           = Prefs()->defaultSelectWordTap;
    historyP->selectedWordAction      = Prefs()->defaultSelectedWordAction;
    historyP->enableMargins           = Prefs()->defaultEnableMargins;
    StrCopy( historyP->userFontName, Prefs()->defaultMainUserFontName );
}
