/*
 * $Id: prefsform.h,v 1.18 2006/11/12 16:23:44 prussar Exp $
 *
...
void ShowPrefsFormObject( UInt16 id, Boolean isControl ) PREFSFORM_SECTION;
void HidePrefsFormObject( UInt16 id, Boolean isControl ) PREFSFORM_SECTION;
