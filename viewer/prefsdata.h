/*
 * $Id: prefsdata.h,v 1.104 2008/01/21 16:44:41 prussar Exp $
 *
...
typedef enum {
    ...
    SELECT_WORD_LOOKUP_PPI,
    SELECT_WORD_LOOKUP_SEARCH_FORM,
    SELECT_WORD_LOOKUP_TO_CLIPBOARD,
    SELECT_WORD_LOOKUP_ANNOTATE
} SelectType;
...
typedef struct {
    ...
    Boolean             defaultEnableSoftHyphens;
    ...
    Boolean             defaultEnableMargins;
    Boolean             enableMargins;
    Boolean             noAnnotationsInBookmarkList;
    Boolean             alwaysDeleteAnnotations;
} Preferences;
...
typedef struct {
    ...
    Boolean             autoscrollStayOn;
    Boolean             strikethrough;
    UInt8               unused0; /* used to be linkClick */
    Boolean             multipleSelect;
    Boolean             underlineMode;
    SearchModeType      searchMode;
    UInt8               searchFlags;
    ...
    SelectType          jogMode[ NUM_OF_JOGEVENTS ];
    Boolean             jogEnabled;
    UInt8               unused1;  /* used to be previousSilkStatus */
    FontModeType        fontModeLibrary;
    CategoryStyleType   categoryStyle;
    Boolean             enableSoftHyphens;
    HardcopyActionType  hardcopyAction;
    ...
    SelectType          arrowMode[ NUM_OF_ARROW_BUTTONS ];
    Boolean             arrowKeys;
    UInt8               unused2; /* used to be dynamicScrollbar */
    UInt8               unused3; /* used to be visualAid */
    Boolean             indicateOpened;
    Char                mainUserFontName[ dmDBNameLength ];
    Char                libraryUserFontName[ dmDBNameLength ];
    Boolean             individualDocumentFonts;
    ...
    SelectWordTapType   selectWordTap;
    SelectedWordActionType selectedWordAction;
    Boolean             unused4; /* used to be hideSonyStatusBar */
    Boolean             useDateTime;
    UInt16              searchXlit;
} OldPreferences;
