/*
 * $Id: jogdial.h,v 1.18 2007/02/15 15:16:43 prussar Exp $
 *
...
/* If we have all three of Sony SDK, Handera SDK and palmOne SDK */
#if defined( HAVE_HANDERA_SDK ) && defined( HAVE_PALMONE_SDK ) && defined( HAVE_SONY_SDK )
...
/* If we have both of Handera SDK and palmOne SDK */
#if defined( HAVE_HANDERA_SDK ) && defined( HAVE_PALMONE_SDK ) 
...
/* If we have both Sony SDK and palmOne SDK */
#if defined( HAVE_PALMONE_SDK ) && defined( HAVE_SONY_SDK )
...
#endif /* HAVE_PALMONE_SDK && HAVE_SONY_SDK */

#endif /* HAVE_HANDERA_SDK && HAVE_PALMONE_SDK */

#endif /* HAVE_HANDERA_SDK && HAVE_PALMONE_SDK && HAVE_SONY_SDK */
