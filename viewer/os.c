/*
 * $Id: os.c,v 1.97 2007/02/15 15:16:44 prussar Exp $
 *
...
static Boolean      supportNVFS = false;
...
/* Return status for NVFS support */
Boolean SupportNVFS( void )
{
    return supportNVFS;
}
