/*
 * $Id: uncompress.c,v 1.52 2006/04/16 23:12:44 prussar Exp $
 *
...
Err CreateUncompressBuffer( void )
{
    ...
    SafeSetRecyclable( cardNo, DmFindDatabase( cardNo, uncompressName ) );
