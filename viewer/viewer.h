/*
 * $Id: viewer.h,v 1.62 2007/05/30 21:39:01 chrish Exp $
 *
...
#define ANNOTATION_SECTION      __attribute__ ((section( "sec4" )))
#define XLIT_SECTION            __attribute__ ((section( "sec4" )))
#define LIST_SECTION            __attribute__ ((section( "sec4" )))
#define CACHE_SECTION           __attribute__ ((section( "sec4" )))
#define RESIZE_SECTION          __attribute__ ((section( "sec4" )))
...
#define ANNOTATIONFORM_SECTION  __attribute__ ((section( "sec5" )))
#define CPUSPEED_SECTION        __attribute__ ((section( "sec5" )))

#define PREFSDATA_SECTION       __attribute__ ((section( "sec6" )))
#define PREFSFORM_SECTION       __attribute__ ((section( "sec6" )))
#define AXXPAC_SECTION          __attribute__ ((section( "sec6" )))
