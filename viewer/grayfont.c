/*
 * $Id: grayfont.c,v 1.42 2006/04/29 05:33:57 prussar Exp $
 *
      ...
      )
{
    ...
    if ( ch < currentFontPtr->header.firstChar ||
        ...
        if ( currentFontPtr->header.firstChar <= MISSING_CHAR &&
	     MISSING_CHAR <= currentFontPtr->header.lastChar ) 
            index = MISSING_CHAR - currentFontPtr->header.firstChar;
        else
