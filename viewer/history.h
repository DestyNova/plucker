/*
 * $Id: history.h,v 1.34 2005/08/27 15:08:59 prussar Exp $
 *
...
/* Set per-document settings to their defaults */
void SetIndividualSettingsToDefaults( History* historyP ) HISTORY_SECTION;
