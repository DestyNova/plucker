/*
 * $Id: prefsautoscroll.c,v 1.7 2004/09/26 11:39:53 nordstrom Exp $
 *
    ...
    )
{
    ...
    switch ( action ) {
        ...
        case LOAD:
            if ( AUTOSCROLL_MAX_JUMP_VALUE < Prefs()->autoscrollJump )
                Prefs()->autoscrollJump = AUTOSCROLL_MAX_JUMP_VALUE;
            ...
            SetListToSelection( frmPrefsAutoscrollModeList,
                frmPrefsAutoscrollModePopup, autoscrollMode );
