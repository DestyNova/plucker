/*
 * $Id: paragraph.h,v 1.49 2006/11/12 02:00:56 prussar Exp $
 *
...
extern Char* GetSelectedWord ( RectangleType* bounds, Int16* paragraphPtr,
    UInt16* startPtr, UInt16* endPtr ) PARAGRAPH_SECTION;
/* Done looking for selected word? */
extern Boolean SelectedWordDone( void ) PARAGRAPH_SECTION;
#endif

/* Find paragraph number by text offset */
UInt16 GetParagraphNumber( Header* record, UInt16 offset ) 
          PARAGRAPH_SECTION;

/* Find paragraph offset */
Int16 GetParagraphOffset( Header* record,
          Paragraph* paragraph )
          PARAGRAPH_SECTION;
