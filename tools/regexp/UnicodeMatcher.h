#ifndef __UNICODEMATCHER_H__
#define __UNICODEMATCHER_H__
...
/**
  ...
  {@link UnicodePattern UnicodePattern} object. Using a <code>UnicodeMatcher</code> is the preferred
  method for scanning strings. UnicodeMatchers are not thread-safe. UnicodeMatchers require
  ...
  <p>
  Unlike Java's <code>UnicodeMatcher</code>, this class allows you to change the string
  ...
  UnicodePattern::registerUnicodePattern("entry", "[^:]+");
  UnicodePattern * p = UnicodePattern::compile("^({entry}):({entry}):({entry}):({entry}):({entry}):({entry}):({entry})$",
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;UnicodePattern::MULTILINE_MATCHING | UnicodePattern::UNIX_LINE_MODE);
  UnicodeMatcher * m = p->createUnicodeMatcher("");
  ...
  @version   0.02a
  @memo Mutable object used on instances of a UnicodePattern class
 */
class UnicodeMatcher
{
  ...
  private:
     ...
     */
    UnicodeMatcher(UnicodePattern * pattern, const std::wstring & text);
  protected:
